  ...
  _(window).on("load", function () {
    !(function () {
      ...
      if (0 < t.length) {
        ...
        (e = s
          ? "https://maps.google.com/maps/api/js?key=" + s + " &sensor=false"
    ...
    jQuery(document).ready(function () {
      ...
      objectFitImages(),
          ...
          if (s.length) {
            ...
            e.on("click", function () {
              ...
              _(document).on("click", function (e) {
                _(e.target).closest(".dropdown-trigger, .aside-dropdown__inner")
                  .length ||
                  (s.removeClass("aside-dropdown--active"),
                  e.stopPropagation());
              });
        ...
        (i = _(".tabs")).length &&
          i.responsiveTabs({ startCollapsed: "false" }),
        (t = _(".js-counter")).length && t.counterUp({ delay: 10, time: 1500 }),
        (r = _(".projects-masonry")).length &&
          r.isotope({
            ...
            e.on("click", function () {
              ...
              e.on("click", function () {
                e.removeClass("filter-panel__item--active"),
                  _(this).addClass("filter-panel__item--active");
              });
          }
        })(),
        (function () {
        ...
        (n = _(".shop__aside-trigger")).length &&
          ...
          _(".shop__backdrop").on("click", function () {
            _(this).removeClass("shop__backdrop--visible"),
              _("body")
                .find(".aside-holder")
                .removeClass("aside-holder--visible");
          })),
